...
#define kMFBundleIDApp      @"com.sametrouble.mac-mouse-fix"
#define kMFBundleIDHelper   @"com.sametrouble.mac-mouse-fix.helper"
...
#define kMFLaunchdHelperIdentifierSM  @"com.sametrouble.mac-mouse-fix.helper"
